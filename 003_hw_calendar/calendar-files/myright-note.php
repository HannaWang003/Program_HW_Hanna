...
<div class="row">
            ...
            ?>
            <div class="col-12 col-sm-4 myfs-vh3 d-flex align-items-center justify-content-end text-light"><?=date("A h:i:s")?></div>
            </div>
    ...
    <button class="btn border-dark mybg-c5" type="submit" data-bs-toggle="popover" data-bs-trigger="hover" title="NOTED"><i class="fa-solid fa-clipboard fa-xl" style="color:rgb(255,204,203)"></i></button> 
    <button class="btn border-dark mybg-c5" type="reset" data-bs-toggle="popover" title="CANCLE"><i class="fa-solid fa-eraser fa-xl" style="color:rgb(255,204,203)"></i></button> 
  </div>
                </form>
            </div> 
<!-- section_note -->
...
if($limitD<=0){
  ?>
  <p class="bg-secondary text-dark">overdue X <?=$limitD?>dyas</p> 
  <?php
  } 
  elseif($limitD==1){
    ?>
