...
<body>
    <div class="container">
        <div class="row mt-2">
            <button type="button" class="col-12 col-sm m-1 py-2 btn mybtn"><a class="text-dark" href="./calendar.php?your_choice=1"><i class="fa-regular fa-hand-scissors fa-xl"></i></a></button>
            <button type="button" class="col-12 col-sm m-1 py-2 btn mybtn"><a class="text-dark" href="./calendar.php?your_choice=2"><i class="fa-regular fa-hand-back-fist fa-xl"></i></a></button>
            <button type="button" class="col-12 col-sm m-1 py-2 btn mybtn"><a class="text-dark" href="./calendar.php?your_choice=3"><i class="fa-regular fa-hand fa-xl"></i></a></button>
        </div>
